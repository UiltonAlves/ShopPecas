...
public class ClienteJuridica {
	...
	@SequenceGenerator(name = "seq_clienteJuridico", sequenceName = "seq_clienteJuridico", initialValue = 1, allocationSize = 1)	
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seq_clienteJuridico")
	@Id
	private Integer id;
